...
def dashboard(request):
    # rentage= Property.objects.filter("RENT").count()
    # sale= Property.objects.filter("FOR SALE").count()
    # pt=Property.objects.all().count()
    # content ={'rentage':ref,'sale':sall, 'pt': pyt}
